...
const translations = {
    en: {
        ...
        'hero.title3': '',
        'hero.description': 'Brand sites, web apps, softwares. Built for international clients.',
        'hero.cta1': 'Browse Sectors',
    ...
    es: {
        ...
        'hero.title3': '',
        'hero.description': 'Sitios de marca, aplicaciones web, softwares. Construido para clientes internacionales.',
        'hero.cta1': 'Ver Sectores',
